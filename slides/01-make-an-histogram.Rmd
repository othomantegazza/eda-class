...
There is a function that read lines from a file, it 

```{r}
sample_file <- file("https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2019/2019-01-15/launches.csv")
