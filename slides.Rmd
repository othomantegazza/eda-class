...
You can manipulate your data with [dplyr](https://dplyr.tidyverse.org/).
Learn [how to use dplyr here](https://cran.r-project.org/web/packages/dplyr/vignettes/dplyr.html) or [with this chapter of r4ds](https://r4ds.had.co.nz/transform.html).

---

You might want to **filter** your data, **summarize** them, or **mutate** them making new columns. 

Or [much more](https://r4ds.had.co.nz/wrangle-intro.html)...

# Source

---

I made  this presentation with the [R markdown](https://rmarkdown.rstudio.com/) implementation of [reveal.js](https://revealjs.com/#/).

The [source code is here](https://github.com/othomantegazza/eda-class/blob/master/slides.Rmd).
